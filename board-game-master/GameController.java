...
public class GameController implements PlayerListener {
  ...
  public void takeTurn() {
    ...
    System.out.println("dice=" + d1.getFace());
    System.out.println("dice=" + d2.getFace());
  }
  ...
  public void hasWon(Player owner) {
    if (winner == null) { // first winner only
      winner = owner;
      ImageIcon icon = new ImageIcon("C:/Users/Poppy/Desktop/board-game-master/src/111.jpg");
      JOptionPane.showMessageDialog(null,"Winner is " + owner, "congratulations",JOptionPane.INFORMATION_MESSAGE, icon);
